...
const STEM_FALLBACKS: Record<string, { decomposition: ConceptDecomposition; candidates: CoiningCandidate[] }> = {
  ...
  computer: {
    decomposition: {
      ...
      relatedSesothoRoots: ['kelello (mind/brain)', 'motlakase (electricity)', 'ho bala (to count/read)', 'ho hlophisa (to organize/process)', 'dipalo (numbers)', 'dintlha (data)'],
    },
    candidates: [
      {
        sesothoWord: 'sebaladipalo',
        method: 'Compounding',
        strategyTier: 1,
        prefix: 'se-',
        root: 'bala (to count) + dipalo (numbers)',
        explanation: 'Compounded from instrumental prefix "se-" + "bala" (to count) + "dipalo" (numbers). Literally: "number-counting instrument". Modeled after Icelandic "tölva" (number-prophetess). Tells the speaker exactly what the machine does.',
        definition: 'A computer / electronic calculator — an instrument for processing numbers and data.',
        partOfSpeech: 'Noun (Class 7)',
        inspiration: '🇮🇸 Icelandic model: tölva (number-prophetess)',
      },
      {
        sesothoWord: 'kelello ya motlakase',
        method: 'Semantic Calque',
        strategyTier: 1,
        explanation: 'Direct associative genitive translation of Chinese 电脑 (diànnǎo = "electric brain"): "kelello" (mind/brain) + "ya" (of) + "motlakase" (electricity). Literally: "electric brain/mind".',
        definition: 'A computer — an electronic device that processes information.',
        partOfSpeech: 'Noun phrase (Class 9)',
        inspiration: '🇨🇳 Chinese model: 电脑 = electric-brain',
      },
      {
        sesothoWord: 'sehlophisadintlha',
        method: 'Compounding',
        strategyTier: 2,
        prefix: 'se-',
        root: 'hlophisa (to organize) + dintlha (data)',
        explanation: 'Compounded from "se-" (instrumental prefix) + "hlophisa" (to organize/structure) + "dintlha" (data/facts). Literally: "data processor/organizer".',
        definition: 'A computer / data processor — a device designed to structure digital data.',
        partOfSpeech: 'Noun (Class 7)',
        inspiration: '🇩🇪 German model: Datenverarbeitungsanlage (data processor)',
      }
    ],
  },
  molecule: {
